...
# step : 1 - building the rag retrival
...
# get the books (paths relative to this script, so it runs from any CWD)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
acedemic_retriever = build_retriver(os.path.join(BASE_DIR, "academics_handbook.pdf"))
fee_retriever = build_retriver(os.path.join(BASE_DIR, "fee_structure.pdf"))
